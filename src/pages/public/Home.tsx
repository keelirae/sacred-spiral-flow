  ...
  <Section title="The Journey" eyebrow="The Sacred Spiral" spiralAccent>
          <div className="bg-foreground/[0.07] -mx-4 px-4 py-8 rounded-2xl">
            <div ref={aboutReveal.ref} className={`space-y-4 transition-all duration-700 ${aboutReveal.visible ? 'animate-slide-up' : 'opacity-0 translate-y-4'}`}>
              <p className="text-xl mx-[5px] my-[5px] px-[5px] py-[5px]">𝑨 𝒘𝒐𝒎𝒆𝒏'𝒔 𝒉𝒆𝒂𝒍𝒊𝒏𝒈 𝒅𝒐𝒆𝒔𝒏'𝒕 𝒉𝒂𝒑𝒑𝒆𝒏 𝒊𝒏 𝒂 𝒔𝒕𝒓𝒂𝒊𝒈𝒉𝒕 𝒍𝒊𝒏𝒆. <br /> 𝑰𝒕 𝒔𝒑𝒊𝒓𝒂𝒍𝒔 𝒍𝒂𝒚𝒆𝒓 𝒃𝒚 𝒍𝒂𝒚𝒆𝒓, 𝒅𝒆𝒆𝒑𝒆𝒓 & 𝒄𝒍𝒆𝒂𝒓𝒆𝒓 𝒆𝒂𝒄𝒉 𝒕𝒊𝒎𝒆. <br /> 𝑻𝒉𝒊𝒔 𝒊𝒔 𝒕𝒉𝒆 𝒔𝒑𝒊𝒓𝒂𝒍.</p>
              <p className="text-lg"></p>
              <p className="mx-[5px] my-[5px] px-[5px] py-[5px] text-lg">We begin at the base: the body. <br />
Here, you return to your rhythms—learning to align movement with breath, nourishment with cycle, strength with softness. <br /> This phase isn’t about pushing harder—it’s about remembering how to listen. You’ll root into the intelligence of your body, rebuild your energy, and regulate your hormones with aligned nutrition and movement practices that work with your cycle, not against it.</p>
              <p className="mx-[5px] my-[5px] px-[5px] py-[5px] text-lg">As your body finds its ground, the mind begins to open. <br /><br />
Now we ascend into the mental realm—where clarity begins. <br /> This is where we examine our inner landscape: the stories we carry, the voices we’ve inherited, the beliefs that have kept us small. <br /> Through shadow work, nervous system awareness, and the rewiring of old patterns, you’ll begin to reclaim your mental sovereignty. No more shame loops. No more bypassing. Just gentle, structured remembrance of who you truly are.</p>
              <p className="mx-[5px] my-[5px] px-[5px] py-[5px] text-lg">And from this integration, the spirit awakens. <br /><br /> You arrive at the center—where everything quiets and deepens. <br /> This is the realm of ceremony, breathwork, earth-based ritual, and feminine embodiment. You’ll root into your spiritual self—not as something outside you, but something you’ve always carried. You’ll learn to move with the moon, create sacred space, work with herbs and elements, and restore your relationship with the unseen. You’ll remember how to commune with your higher self, your inner child, and the wild wisdom within.</p>
              <p className="text-xl mx-[5px] my-[5px] px-[5px] py-[5px]">𝑻𝒉𝒊𝒔 𝒊𝒔 𝒕𝒉𝒆 𝒔𝒂𝒄𝒓𝒆𝒅 𝒔𝒑𝒊𝒓𝒂𝒍. <br />⁣ 𝑵𝒐𝒕 𝒂 𝒑𝒓𝒐𝒈𝒓𝒂𝒎. ⁣<br /> 𝑨 𝒑𝒂𝒕𝒉 𝒃𝒂𝒄𝒌 𝒉𝒐𝒎𝒆.</p>
            </div>
          </div>
        </Section>
        <SpiralDivider />
